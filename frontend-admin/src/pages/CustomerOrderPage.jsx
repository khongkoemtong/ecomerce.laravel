  ...
  return (
    <div className="p-4 md:p-8 flex flex-col transition-colors duration-200 min-h-screen">
      ...
      <div className="flex items-center gap-4 mb-8 shrink-0">
        <button 
          onClick={() => navigate(-1)}
          className="p-2.5 rounded-none border border-gray-200 dark:border-gray-700 bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm hover:bg-white dark:hover:bg-gray-700 hover:shadow-lg transition-all duration-300 shadow-sm"
          title="Go Back"
        >
      ...
      <div className="w-full max-w-7xl mx-auto flex flex-col lg:flex-row gap-8">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-none p-6 shadow-sm border border-gray-100 dark:border-gray-700">
            ...
            <div className="flex flex-wrap items-center gap-2">
              <button 
                ...
                className={`px-4 py-2 text-sm font-medium rounded-none transition-colors border ${status === 'Pending' ? 'bg-orange-500 text-white border-orange-500 shadow-md' : 'bg-transparent text-gray-700 dark:text-gray-300 border-gray-300 dark:border-gray-600 hover:bg-gray-50 dark:hover:bg-gray-700'}`}
              >
                Pending
              </button>
              ...
              <button 
                ...
                className={`px-4 py-2 text-sm font-medium rounded-none transition-colors border ${status === 'Processing' ? 'bg-orange-500 text-white border-orange-500 shadow-md' : 'bg-transparent text-gray-700 dark:text-gray-300 border-gray-300 dark:border-gray-600 hover:bg-gray-50 dark:hover:bg-gray-700'}`}
              >
                Processing
              </button>
              ...
              <button 
                ...
                className={`px-4 py-2 text-sm font-medium rounded-none transition-colors border ${status === 'Shipped' ? 'bg-orange-500 text-white border-orange-500 shadow-md' : 'bg-transparent text-gray-700 dark:text-gray-300 border-gray-300 dark:border-gray-600 hover:bg-gray-50 dark:hover:bg-gray-700'}`}
              >
                Shipped
              </button>
            </div>
        ...
        <div className="w-full lg:w-2/3 flex flex-col gap-4">
          <div className="flex items-center justify-between mb-2">
            ...
            <span className="bg-gray-100 dark:bg-gray-800 text-gray-600 dark:text-gray-300 px-3 py-1 rounded-none text-sm font-semibold">
          ...
          {products.length > 0 ? (
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              {products.map((item, idx) => (
                <div key={idx} className="bg-white dark:bg-gray-800 rounded-none p-5 shadow-[0_4px_20px_rgba(0,0,0,0.03)] dark:shadow-[0_4px_20px_rgba(0,0,0,0.2)] border border-gray-100 dark:border-gray-700 flex flex-col hover:shadow-lg hover:-translate-y-1 transition-all duration-300 overflow-hidden group">
                  ...
                  <div className="w-full h-48 bg-gray-50 dark:bg-gray-900 rounded-none mb-5 relative overflow-hidden flex items-center justify-center">
                    ...
                    {/* Quantity Badge */}
                    <div className="absolute top-3 right-3 bg-white/90 dark:bg-gray-800/90 backdrop-blur shadow-md px-3 py-1 rounded-none text-sm font-bold text-gray-900 dark:text-white border border-gray-200/50 dark:border-gray-700/50">
                      x{item.qty}
                    </div>
                  </div>
